...
class CircularMenuState extends State<CircularMenu>
  ...
  late Animation<double> _ringSizeAnimation;
  late Animation _ringSizeCurve;
  Animation<Color?>? _colorAnimation;
  late Animation _colorCurve;
  double _sizeAnimation= 0;
 ...
 _ringSizeCurve = CurvedAnimation(
        parent: _animationController,
        curve: Interval(0.4, 1.0, curve: widget.animationCurve));
    _ringSizeAnimation = Tween<double>(begin: 0, end: 1.0)
        .animate(_rotateCurve as Animation<double>)
          ..addListener(() {
            setState(() {});
          });
